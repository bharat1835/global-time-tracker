...
CITY_ALIASES = {
    ...
    "orlando": "America/New_York", "detroit": "America/New_York",
    "chicago": "America/Chicago", "dallas": "America/Chicago",
    "houston": "America/Chicago", "austin": "America/Chicago",
    "minneapolis": "America/Chicago", "mexico city": "America/Mexico_City",
    ...
    "calgary": "America/Edmonton", "winnipeg": "America/Winnipeg",
    # Latin America
    ...
    "havana": "America/Havana", "panama city": "America/Panama",
    ...
    "hamburg": "Europe/Berlin", "madrid": "Europe/Madrid",
    "barcelona": "Europe/Madrid", "rome": "Europe/Rome",
    "milan": "Europe/Rome", "amsterdam": "Europe/Amsterdam",
    "brussels": "Europe/Brussels", "zurich": "Europe/Zurich",
    ...
    "cairo": "Africa/Cairo", "amman": "Asia/Amman",
    ...
    "kuala lumpur": "Asia/Kuala_Lumpur", "hanoi": "Asia/Bangkok",
...
ICON_MAP = [
    ...
    (("new york", "nyc", "boston", "chicago", "toronto", "washington",
      ...
      "san jose", "vancouver", "miami", "atlanta", "philadelphia",
      "houston", "austin", "phoenix", "portland", "las vegas",
      "san diego", "ottawa", "montreal", "calgary", "winnipeg",
      "minneapolis", "detroit", "orlando", "salt lake city",
      "anchorage", "honolulu", "hawaii"), "skyline"),
    (("tokyo", "seoul", "osaka"), "torii"),
    (("dubai", "abu dhabi"), "burj"),
    (("mumbai", "delhi", "bangalore", "bengaluru", "chennai", "kolkata",
      "hyderabad", "pune", "india", "karachi", "islamabad", "lahore",
      "dhaka", "colombo", "kathmandu"), "gate"),
    (("singapore",), "merlion"),
    (("hong kong", "shanghai", "beijing", "shenzhen", "taipei", "china"), "pagoda"),
    (("moscow", "st petersburg"), "onion"),
]
